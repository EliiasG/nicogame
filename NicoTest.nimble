...
task runr, "Runs NicoTest for current platform":
 exec &"nim c -r {releaseOpts} -o:NicoTest src/main.nim"

task rund, "Runs debug NicoTest for current platform":
 exec &"nim c -r {debugOpts} -o:NicoTest src/main.nim"

task release, "Builds NicoTest for current platform":
 exec &"nim c {releaseOpts} -o:NicoTest src/main.nim"

task webd, "Builds debug NicoTest for web":
 exec &"nim c {debugOpts} -d:emscripten -o:NicoTest.html src/main.nim"

task webr, "Builds release NicoTest for web":
 exec &"nim c {releaseOpts} -d:emscripten -o:NicoTest.html src/main.nim"

task debug, "Builds debug NicoTest for current platform":
 exec &"nim c {debugOpts} -o:NicoTest_debug src/main.nim"
